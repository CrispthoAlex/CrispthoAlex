<!--
**CrispthoAlex/CrispthoAlex** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
  ...
  animation: 5s cubic-bezier(.5, 0, .5, 1.2) 1s infinite bounce;
      ...
      <div class="firstprofile">
        ...
        <p>
          <strong>
            Hi everyone.
            Welcome to my GitHub profile. Enjoy, Follow me and let's Share content 👋
          </strong>
        </p>
      </div>
    </div>
